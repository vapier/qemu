...
microblaze microblazeel or1k x86_64 bfin_elf bfin_flat"
...
bfin_elf_magic='\x7fELF\x01\x01\x01\x00\x00\x00\x00\x00\x00\x00\x00\x00\x02\x00\x6A\x00'
bfin_elf_mask='\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xfe\xff\xff'
bfin_elf_family=bfin

bfin_flat_magic='bFLT\x00\x00\x00\x04'
bfin_flat_mask='\xff\xff\xff\xff\xff\xff\xff\xff'
bfin_flat_family=bfin
